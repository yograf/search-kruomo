// Main content script.
  ...
  // Add buttons.
  $('.krumo-element:not(".processed")').addClass('processed')
  .append('<span class="krumo-get-path"><a href="#">Path</a></span>')
  .append('<span class="krumo-get-value"><a href="#">Value</a></span>')
  .append('<span class="krumo-get-eq"><a href="#">Condition</a></span>');
  ...
  $('.krumo-get-path').click( function() {
    ...
    self.port.emit("my-addon-message",  trail);
